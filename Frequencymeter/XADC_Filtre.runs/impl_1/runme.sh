...
HD_PWD='D:/XADC_Filtre_certo/XADC_Filtre.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_Filtre.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source XADC_Filtre.tcl -notrace
